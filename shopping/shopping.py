...
def evaluate(labels, predictions):
    ...
    """
    # raise NotImplementedError
    true_positive_rate = true_negative_rate = false_positive_rate = false_negative_rate = 0
    for true_val, predicted_val in zip(labels, predictions):
        if true_val == predicted_val == 1:
            true_positive_rate += 1
        elif true_val == predicted_val == 0:
            true_negative_rate += 1
        elif true_val == 1 and predicted_val == 0:
            false_negative_rate += 1
        elif true_val == 0 and predicted_val == 1:
